		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://mfikri.com/" target="_blank">Nurul Fadilah</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>Saya Telah Mengerjakan Tugas Sesuai Dengan KebutuhanYang di Butuhkan.</p>
				</div>
			</div>
		</div>
		<?php
