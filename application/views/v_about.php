...
<html class="no-js"> <!--<![endif]-->
	...
	<meta name="author" content="Nurul fadila" />
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">BPN<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://mfikri.com/" target="_blank">Nurul fadila</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-about animate-box">
		<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
			<h2>About Us</h2>
			<p>Badan Pertanahan Nasional (disingkat BPN) adalah lembaga pemerintah nonkementerian di Indonesia yang mempunyai tugas melaksanakan tugas pemerintahan di bidang Pertanahan sesuai dengan ketentuan peraturan perundang-undangan. .</p>
		</div>
		<div class="container">
			<div class="col-md-6">
				<figure>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Nurul fadillah</h3>
						<h4>Co-Founder, CEO</h4>
						<p>Nurul fadilah adalah seorang mahasiswa dari perguruan tinggi swasta universitas cokroaminoto palopo.</p>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Nurul Fadilah adalah seorang web designer dari perguruan tinggi di daerah Palopo.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Nurul Fadilah adalah seorang mahasisawa konsentrasi multimedia di salah satu kampus universitas cokroaminoto palopo.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 text-center item-block">
					...
					<p>Tingkatkan kinerja saya dengan Software yang sesuai dengan Business Process anda.</p>
				...
				<div class="col-md-4 text-center item-block">
					...
					<h3>WEB DESIGN</h3>
					<p>Bangun identitas bisnis dan usaha saya di dunia Internet melalui Website.</p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Learn more <i class="icon-arrow-right"></i></a></p>
				</div>
			</div>
		</div>
