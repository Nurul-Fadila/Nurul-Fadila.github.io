	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Nurul<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>My blog By Nurul Fadilah</h2>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>2022,23 juli , Palopo, Wara, Tompotika, Sulawesi Selatan</li>
						<li><i class="icon-phone"></i>+ 1235 2355 98</li>
						<li><i class="icon-envelope"></i><a href="#">Nurul@yoursite.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.Nurulfadilah.com</a></li>
					</ul>
				</div>
